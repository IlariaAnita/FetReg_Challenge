...
def deeplabv3_ResNet_hog(Pre_Trained, progress, n_classes):
    if Pre_Trained == True:
        model = torchvision.models.segmentation.deeplabv3_resnet50(Pre_Trained, progress, num_classes=21)
        if n_classes != 21:
            model = torchvision.models.segmentation.deeplabv3_resnet50(Pre_Trained, progress)
        ...
        model = torchvision.models.segmentation.deeplabv3_resnet50(Pre_Trained, progress, num_classes=n_classes)
